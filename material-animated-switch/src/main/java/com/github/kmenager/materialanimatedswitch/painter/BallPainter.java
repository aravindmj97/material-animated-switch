...
import com.github.kmenager.materialanimatedswitch.MaterialAnimatedSwitchState;
import com.github.kmenager.materialanimatedswitch.R;
...
public class BallPainter implements SwitchInboxPinnedPainter {
    ...
    public BallPainter(int bgColor, int toBgColor, int padding, int ballRadius,
    ...
    private void init() {
        ...
        // Add shadow in ball painter to avoid Listener called twice when switch checked
        shadow = new Paint();
        shadow.setColor(Color.parseColor("#99000000"));
        shadow.setMaskFilter(new BlurMaskFilter(3, BlurMaskFilter.Blur.NORMAL));
    ...
    public void draw(Canvas canvas) {
        canvas.drawCircle(ballPositionX, middle + 2, radius, shadow);
