...
public class IconPressPainter extends IconPainter {
    ...
    public IconPressPainter(Context context, Bitmap bitmap, int ballRadius, int iconSize, BallFinishObservable ballFinishObservable,
                            BallMoveObservable ballMoveObservable, int margin) {
        super(context, bitmap, margin, iconSize);
        initValueAnimator();
    ...
    private void initValues() {
        ...
        iconXPosition = ballMoveObservable.getBallPosition() - iconMargin;
    }
